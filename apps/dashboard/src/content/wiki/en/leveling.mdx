...
1. Navigate to **Dashboard** → **Leveling**
...
1. Go to **Leveling** → **Announcements**
...
```
Level 25  → Special color role + Channel access
Level 50  → VIP perks + Custom emoji
Level 100 → Exclusive role + Giveaway entry
```
