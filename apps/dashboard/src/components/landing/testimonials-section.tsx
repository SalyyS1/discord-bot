...
const testimonials = [
  {
    id: '1',
    stars: 5,
    review: "KisBot transformed how we manage our 50k+ member gaming community. The moderation tools are incredible, and the ticket system saves us hours every day.",
    author: 'Alex Chen',
  ...
  },
  {
    id: '2',
    stars: 5,
    review: "The leveling system keeps our members engaged like never before. We've seen a 40% increase in daily activity since switching to KisBot!",
    author: 'Sarah Kim',
    role: 'Server Owner',
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            See what community managers and server owners are saying about KisBot
          </p>
        </motion.div>
